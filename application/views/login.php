...
<body>
    <div class="container">
        ...
        <form action="<?= base_url('loginSystem/login') ?>" method="post" name="login">
            ...
            <div class="col-md-12 mb-3">
                <p class="text-center">Don't have account? <a href="<?= base_url('loginSystem/register') ?>" id="signup">Sign up here</a></p>
            </div>
        </form>
    </div>

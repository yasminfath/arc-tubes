...
<body>
    ...
    <div class="row">
        <div class="col">
            ...
            <br>
            <h3 class="fs-3 mb-3"><a href="<?= base_url('seller/tambah_buku') ?>"><i class="fas fa-plus"></i></a>
            &nbsp; Daftar Buku</h3></h3>
                    ...
                    <tbody>
                        ...
                        foreach($data_buku as $buku)
                        {
                            ...
                            <tr>
                                ...
                                <td>
                                <a href="'. base_url('seller/edit_buku?id_buku='. $buku['id_buku'] .'') . '"><i class="fas fa-edit"></i></a>
                                &nbsp;
                                <a href="'. base_url('seller/hapus_buku?id_buku='. $buku['id_buku'] .'') . '"><i class="fas fa-trash"></i></a>
                                </td>
                                </tr>
                            </tr>
                        ';
